import { IEdgeCreateBody, IEdgeDeleteBody, IEdgeGetBody, IEdgePingBody, IEdgeUpdateBody, INodeCreateBody, INodeDeleteBody, INodeGetBody, INodePingBody, INodeUpdateBody, IUserCreateBody, IUserGetBody, IUserLoginBody, IUserPingBody, IUserUpdateBody } from "./bodies"
import { IEdgeCreateResponse, IEdgeDeleteResponse, IEdgeGetResponse, IEdgePingResponse, IEdgeUpdateResponse, INodeCreateResponse, INodeDeleteResponse, INodeGetResponse, INodePingResponse, INodeUpdateResponse, IUserCreateResponse, IUserGetResponse, IUserLoginResponse, IUserPingResponse, IUserUpdateResponse } from "./responses"
